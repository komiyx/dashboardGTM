...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Build the query
    $query = "SELECT * FROM th_user_records WHERE created_time BETWEEN ? AND ?";
    if ($limit !== 'all') {
        $query .= " LIMIT ?";
    }
    ...
    header('Content-Disposition: attachment; filename="th_user_records_' . $startDate . '_to_' . $endDate . '.xls"');
